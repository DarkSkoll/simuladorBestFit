...
public class ControlPanel extends Frame 
{
  ...
  // 
  Label segment = new Label("0",Label.LEFT);
  Label pagination = new Label("0",Label.LEFT);
  ...
  public void init( Kernel useKernel , String commands , String config ) 
  {
    ...
    //
    segment.reshape(395,250+25,230,15);
    add(segment);

    pagination.reshape(395,275+25,230,15);
    add(pagination);
    ...
    add(highLabel);
	//probando
    Label SegmentacionLabel = new Label("Segmento: " , Label.LEFT) ;
    SegmentacionLabel.reshape(285,250+25,110,15);
    add(SegmentacionLabel);
	// probando

	// probando
    Label PaginaLabel = new Label("Pagina: " , Label.LEFT) ;
    PaginaLabel.reshape(285,275+25,110,15);
    add(PaginaLabel);
	// probando
  ...
  public void paintSeg (int arreglo[]){
    if(arreglo[0] == 0){
        String cadena = "Error Pag: " + arreglo[1] + " y " + arreglo[2] + " Seg. Dif.";
        segment.setText(cadena);
        pagination.setText("------");
    }
    if(arreglo[0] != 0){
        String cadena = arreglo[0] + " ";
        String cadena1 = arreglo[1] + " y " + arreglo[2];
        segment.setText(cadena);
        pagination.setText(cadena1);
    }
  }
